...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        frames[0] = (ImageView)findViewById(R.id.imgView1);
        frames[1] = (ImageView)findViewById(R.id.imgView2);
        frames[2] = (ImageView)findViewById(R.id.imgView3);
        frames[3] = (ImageView)findViewById(R.id.imgView4);
        frames[4] = (ImageView)findViewById(R.id.imgView5);
        frames[5] = (ImageView)findViewById(R.id.imgView6);
        frames[6] = (ImageView)findViewById(R.id.imgView7);
        frames[7] = (ImageView)findViewById(R.id.imgView8);
        frames[8] = (ImageView)findViewById(R.id.imgView9);
